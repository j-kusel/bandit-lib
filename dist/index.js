...
var _require = __webpack_require__("./config/CONFIG.json"),
    ...
    contrast = _require.contrast,
    contrast_light = _require.contrast_light,
    contrast_lighter = _require.contrast_lighter;
...
var colors = {
  ...
  contrast_lighter: contrast_lighter
}; // Form Components
...
var TBDropdown = (0, _styledComponents["default"])(function (props) {
  ...
  }, /*#__PURE__*/_react["default"].createElement(TBToggle, null, props.toggle), /*#__PURE__*/_react["default"].createElement(_reactBootstrap.Dropdown.Menu, null, props.menuItems.map(function (drop) {
...
})([".dropdown-toggle{background-color:red;}color:red;padding:5px 6px;border:none;border-radius:0px;background-color:", ";text-align:center;width:100%;"], c.contrast);
